...
echo ""
echo "🔐 Add these secrets to your GitHub repository (Settings → Secrets and variables → Actions → Secrets):"
echo "   1. GCP_SA_KEY: The JSON key shown above"
echo "   2. DATABASE_URL: Your Neon database connection string"
echo "   3. DATABASE_URL_E2E: Your Neon database connection string for e2e tests"
echo "   4. FLASK_SECRET_KEY: Generate with 'openssl rand -hex 32'"
echo "   5. OPENROUTER_API_KEY: Your OpenRouter API key"
echo ""
echo "🌍 Add these environment variables to your GitHub repository (Settings → Secrets and variables → Actions → Variables):"
echo "   1. GCP_PROJECT_ID: $PROJECT_ID"
echo "   2. GCS_BUCKET_DEV: streets-editor-dev"
echo "   3. GCS_BUCKET_TEST: streets-editor-test"
echo "   4. GCS_BUCKET_PROD: streets-editor-prod"
echo "   5. GCP_REGION: Your preferred region (e.g., europe-west1)"
echo ""
